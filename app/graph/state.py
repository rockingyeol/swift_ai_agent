...
class AgentState(TypedDict, total=False):
    ...
    user_intent: Literal["analyze", "generate", "map", "explain", "schema"]

    # --- PII 마스킹 ---
    pii_mapping: dict[str, str]             # placeholder → 원본 매핑

    # --- 라우팅 ---
    routed_agent: Literal["analyzer", "generator", "mapper", "explainer", "schema_explorer"]
    ...
    # --- HITL ---
    needs_hitl: bool
    hitl_decision: Optional[Literal["approve", "reject", "modify", "error"]]
